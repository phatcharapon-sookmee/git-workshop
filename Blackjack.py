...
# @Last Modified time: 2017-04-22 11:36:52
...
D      DD       D  DDDDD  DDD      D  DD   D 000000  00     00  000000 00   00 D
DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
''')
    win = ('''--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
    ...
    for r in range(Round):
        ...
        if(round_score[0] == 1):
            ...
            score[1] = score[1] + 1
        print('Score PLAYER : BOT is {0}:{1}' .format(score[0], score[1]))
        print()
    if score[0] > score[1]:
        print(win)
...
def player_st(end=False,b_com='Y'):
